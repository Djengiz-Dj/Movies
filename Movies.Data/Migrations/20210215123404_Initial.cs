        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieSubtitles = table.Column<string>(nullable: true),
                    MovieStarring = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Director = table.Column<string>(maxLength: 150, nullable: true),
                    DirectorId = table.Column<int>(nullable: false),
                    DirectoreId = table.Column<int>(nullable: true),
                    YearOfReleise = table.Column<DateTime>(nullable: false),
                    MovieLenght = table.Column<int>(nullable: false),
                    ProductionHouse = table.Column<string>(maxLength: 150, nullable: true),
                    ProductionId = table.Column<int>(nullable: false),
                    PublisherName = table.Column<string>(maxLength: 150, nullable: true),
                    PublisherId = table.Column<int>(nullable: false),
                    ...
                    Starring = table.Column<string>(maxLength: 300, nullable: true),
                    Audio = table.Column<string>(maxLength: 50, nullable: true),
                    Subtitles = table.Column<string>(maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movies_Directores_DirectoreId",
                        column: x => x.DirectoreId,
